...
public final class VideoBuffer {
    ...
    /**
     * OpenGL buffer usage, specifies the expected usage pattern of the data
     * store. The frequency of access may be one of these STREAM
     *
     ...
     * source for GL drawing and image specification commands. READ
     *
     * The data store contents are modified by reading data from the GL, and
     * used to return that data when queried by the application. COPY
     *
     * The data store contents are modified by reading data from the GL, and
