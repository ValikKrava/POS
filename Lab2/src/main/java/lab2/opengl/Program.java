...
import lab2.opengl.VideoBuffer.Type;
import lab2.opengl.VideoBuffer.Usage;
...
public class Program {
     ...
     * {@link Program#bindAttribLocation}
     ...
     * <code>{px,py,pz}{nz,ny,nz}</code> format would be 6 since 3 floats for
     * position and 3 floats for normal vector
     * @param offset - offset from vertex attribute component begin,
     * <code>{px,py,pz}{nz,ny,nz}</code> format should be 0 when binding
     * position and 3 when binding normal vector
     */
    ...
    /**
     * Passes whole vertex attributes into program with layout. Can be used only
     * when all vertex attributes are line stored in the single VBO
     *
